...
<html lang="en">
	<head>
		...
		<meta name="viewport" content="width=device-width, initial-scale=1, shrink-to-fit=no">
            <meta name="keywords" conten="Paper Rock Scissors Game">
            <meta name="description" conten="Paper Rock Scissors Game">
	...
	<body>
				...
				<div class="overlay bg-parallax" data-stellar-ratio="0.9" data-stellar-vertical-offset="0" data-background=""></div>
					<div class="container">
						<div class="banner_content text-center">
							<h2>Paper Rock Scissors Game</h2>
							<div class="page_link">
								<a href="index.php">Home</a>
								<a href="prs.php">Paper Rock Scissors Game</a>
							</div>
		...
		<section class="projects_area p_120">
			<div class="container">
                        <h2>Paper Rock Scissors Game</h2>
				<form action="prs2.php" method="post">
					<p>Your Choice:</p>
					<p>
						<input type="radio" name="choice" value="0">Paper &nbsp;
