	...
	<body>
		<div id="container">
			<div class="image-wrapper">
				<p>
					<img
						class="noshow scale-image"
						src="img/header.jpg"
						alt="Photo of inside of CIS 122 restaurant"
					/>
				</p>
			</div>
			<?php
				...
				if (!empty($_POST['nachos'])) {
					$nachos=$_POST['nachos'];
					$sql =$DBH->prepare("INSERT INTO orders VALUES (NULL, :payment_id, 'Boneless Wings and Skins Sampler', :nachos)");
